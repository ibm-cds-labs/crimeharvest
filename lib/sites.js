...
var philly = {
  ...
  mappingFile: 'http://ibm-watson-data-lab.github.io/open-data/crime/phila_ucr_codes.csv',
...
var chicago = {
  ...
  mappingFile: 'http://ibm-watson-data-lab.github.io/open-data/crime/chicago_iucr_codes.csv',
...
var batonrouge = {
  ...
  mappingFile: 'http://ibm-watson-data-lab.github.io/open-data/crime/batonrouge_categories.csv',
...
var sf = {
  ...
  mappingFile: 'http://ibm-watson-data-lab.github.io/open-data/crime/SF_categories.csv',
...
var boston = {
  ...
  resource: '29yf-ye7n',
  mappingFile: 'http://ibm-watson-data-lab.github.io/open-data/crime/boston_ucr_codes.csv',
...
var vegas = {
  ...
  mappingFile: 'http://ibm-watson-data-lab.github.io/open-data/crime/vegas_types.csv',
...
var nola = {
  ...
  resource: 'bevf-jgit.json',
  mappingFile: 'http://ibm-watson-data-lab.github.io/open-data/crime/NOLAcrimecodes.csv',
  select: ['nopd_item','type','typetext','initialtype','mapx','mapy','timeclosed','block_address','location'],
  where: function() {
    var today = new Date();
    var yesterday = new Date();
    yesterday.setDate(today.getDate() - 1);
    ...
    // return 'timeclosed>=\"2017-01-04\" AND timeclosed<\"2017-01-05\"';
  },
  process: function(site, data, mappings) {
    var newcrimes = [];
    for (var i = 0; i < data.length; i++) {
      ...
      // location
      if (thecrime.location) {
        rec.geometry = thecrime.location;
        newcrimes.push(rec);
      }
    }
    return newcrimes;
